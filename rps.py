...
class RPS(object):
    ...
    def load_lighttxt(self, filename=None):
        ...
        """
        self.L = ps_utils.load_lighttxt(filename)
    ...
    def load_lightnpy(self, filename=None):
        ...
        """
        self.L = ps_utils.load_lightnpy(filename)
    ...
    def load_images(self, foldername=None, ext=None):
        ...
        """
        self.M, self.height, self.width = ps_utils.load_images(foldername, ext)
    ...
    def load_npyimages(self, foldername=None):
        ...
        :param foldername: foldername
        """
        self.M, self.height, self.width = ps_utils.load_npyimages(foldername)
    ...
    def load_mask(self, filename=None):
        ...
        mask = ps_utils.load_image(filename=filename)
    ...
    def disp_normalmap(self, delay=0):
        ...
        :return: None
        """
        ps_utils.disp_normalmap(normal=self.N, height=self.height, width=self.width, delay=delay)
    ...
    def save_normalmap(self, filename=None):
        ...
        :return: None
        """
        ps_utils.save_normalmap_as_npy(filename=filename, normal=self.N, height=self.height, width=self.width)
